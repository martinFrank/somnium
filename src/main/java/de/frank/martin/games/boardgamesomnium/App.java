...
public class App {
    ...
    public static void main(String[] args){
        ...
        printer.showResults(System.out);
    ...
    private static void handleKeyboardInput(SomniumGame somniumGame, SomniumGamePrinter printer) {
        ...
        while (true){
            ...
            if (isCommand(SomniumCommand.SHOW,cmd[0] )) {
                printer.printGame(System.out);
            }
            if (isCommand(SomniumCommand.EXIT,cmd[0] )) {
                System.exit(0);
            }
            if (isCommand(SomniumCommand.DRAW,cmd[0] )) {
                somniumGame.drawCard();
                printer.printGame(System.out);
            }
            if (isCommand(SomniumCommand.STEAL,cmd[0] )) {
                try {
            ...
            if (isCommand(SomniumCommand.DONE,cmd[0] )) {
